export default function HomePage(){
 return <main className="min-vh-100 bg-white">
  <nav className="navbar navbar-expand-lg bg-white border-bottom"><div className="container py-2">
   ...
   <div className="d-flex gap-2"><a className="btn btn-link text-decoration-none" href="/pricing">Pricing</a><a className="btn btn-outline-primary" href="/auth/login">Sign in</a><a className="btn btn-primary" href="/auth/register">Get started</a></div>
  </div></nav>
  <section className="container py-5"><div className="row align-items-center g-5 py-lg-5">
   <div className="col-lg-6"><span className="badge text-bg-primary mb-3">Secure media infrastructure</span><h1 className="display-5 fw-bold">Store, organize and deliver media from one clean dashboard.</h1><p className="lead text-secondary">Chunked uploads, private delivery, public assets, API keys, usage monitoring and account security.</p><div className="d-flex flex-wrap gap-2"><a className="btn btn-primary btn-lg" href="/auth/register">Create workspace</a><a className="btn btn-outline-secondary btn-lg" href="/pricing">Compare plans</a><a className="btn btn-link btn-lg" href="/auth/login">Open dashboard</a></div></div>
