...
export default function Page() {
  ...
  return (
    <>
      <PageHeader
        title="Folders"
        subtitle="Organize media with nested workspace folders."
      />
          ...
          <div className="card">
            ...
            {loading ? (
              ...
              <EmptyState
                ...
                text="Create a folder to organize uploaded media."
              />
            ) : (
                ...
                {items.map((f) => (
                  ...
                  >
                    <a
                      ...
                      className="d-flex align-items-center gap-3 text-dark flex-grow-1"
                    >
                      ...
                      <div>
                        ...
                        <div className="text-secondary small">{f.pathKey}</div>
                      </div>
                    </a>
                    <button
