...
export default function Page() {
  ...
  const load = () =>
    apiRequest<{ data: K[] }>("/api/v1/api-keys")
  ...
  return (
    <>
      <PageHeader
        title="API keys"
        subtitle="Scoped credentials for server-to-server access."
      />
      <Feedback message={msg} variant="danger" />
      {secret && (
          ...
          <form className="card" onSubmit={create}>
            ...
            <div className="card-body">
              ...
              <div className="row g-2">
                {scopes.map((s) => (
                  <div className="col-sm-6" key={s}>
                    <label className="form-check border rounded p-2 ps-5 w-100">
                      <input
          ...
          <div className="card">
            ...
            {loading ? (
              ...
              <div className="list-group list-group-flush">
                {keys.map((k) => (
                  <div className="list-group-item" key={k.id}>
                    <div className="d-flex justify-content-between gap-3">
                      <div>
                        <strong>{k.name}</strong>
                        <div className="text-secondary small">{k.prefix}</div>
                      </div>
                      {k.revokedAt ? (
