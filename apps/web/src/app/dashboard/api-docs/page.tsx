...
const cards = [
  {
    ...
    description:
      "Upload PUBLIC images for a permanent imgUrl or PRIVATE media for signed delivery.",
  ...
  },
  {
    ...
    description:
      "Copy a complete skill into ChatGPT, Claude, Cursor, Copilot or another coding agent.",
  ...
  },
  {
    ...
    description:
      "Next.js, Node.js, Express, Fastify and PHP server-side integration examples.",
  ...
  },
  {
    title: "API keys",
    description:
      "Create least-privilege keys for uploads, media reads and optional media updates.",
  ...
  return (
    <>
      ...
      <div className="alert alert-success">
        <strong>Customer documentation only.</strong> Internal endpoint
        inventories, administrator APIs and the full OpenAPI schema are
        restricted to the separate Admin Console.
      </div>
      ...
      <div className="card mt-4">
        ...
        <div className="card-body">
          ...
          <p className="text-secondary small mb-0">
            Add <code>media:write</code> only when the customer application must
            rename, move or change asset visibility after upload.
          </p>
        </div>
      </div>
    </>
