...
export class AdminPaymentsHttpService extends LegacyModuleService { constructor(repository:AdminPaymentsHttpRepository, validation:AdminPaymentsHttpValidation) { super(repository,validation); } }
