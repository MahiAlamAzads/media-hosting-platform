...
export class UploadsHttpService extends LegacyModuleService { constructor(repository:UploadsHttpRepository, validation:UploadsHttpValidation) { super(repository,validation); } }
