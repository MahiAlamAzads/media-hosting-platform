...
export const publicMediaModule: ApiModuleDescriptor={name:"public-media",mountPath:"/i",router:route.router};
export const publicMediaCompatibilityModule: ApiModuleDescriptor={name:"public-media",mountPath:"/api/v1/public",router:route.router};
