...
export class PaygHttpService extends LegacyModuleService { constructor(repository:PaygHttpRepository, validation:PaygHttpValidation) { super(repository,validation); } }
