...
export class PricingHttpService extends LegacyModuleService { constructor(repository:PricingHttpRepository, validation:PricingHttpValidation) { super(repository,validation); } }
