...
export class SecurityHttpService extends LegacyModuleService { constructor(repository:SecurityHttpRepository, validation:SecurityHttpValidation) { super(repository,validation); } }
