...
export class VariantsHttpService extends LegacyModuleService { constructor(repository:VariantsHttpRepository, validation:VariantsHttpValidation) { super(repository,validation); } }
