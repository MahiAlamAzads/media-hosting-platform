...
export class FoldersHttpService extends LegacyModuleService { constructor(repository:FoldersHttpRepository, validation:FoldersHttpValidation) { super(repository,validation); } }
