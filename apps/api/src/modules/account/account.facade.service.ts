...
export class AccountHttpService extends LegacyModuleService { constructor(repository:AccountHttpRepository, validation:AccountHttpValidation) { super(repository,validation); } }
