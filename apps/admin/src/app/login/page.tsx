      ...
      <div className="admin-login-card card">
        <div className="card-body p-4 p-lg-5">
          <div className="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
              <strong className="d-block">Media Platform</strong>
          ...
          <p className="text-secondary mb-4">
            Only emails listed in PLATFORM_ADMIN_EMAILS can continue.
          </p>
          ...
          <div className="d-flex justify-content-between mt-4 small">
            <a href={WORKSPACE_URL}>Workspace app</a>
            <span className="text-secondary">Port 3002</span>
          </div>
        </div>
      </div>
    </main>
