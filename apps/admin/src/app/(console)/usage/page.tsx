  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Aggregated monthly usage across all workspaces and all metered resources."
      >
      ...
      <div className="row g-3 mb-4">
        <div className="col-sm-6 col-xl-3">
          <div className="card stat-card">
            <div className="card-body">
              <div className="text-secondary small">Workspaces represented</div>
        ...
        <div className="col-sm-6 col-xl-3">
          <div className="card stat-card">
            <div className="card-body">
              <div className="text-secondary small">Aggregate rows</div>
      ...
      <div className="card">
        <div className="card-header">
          <strong>Usage aggregates</strong>
        </div>
        {loading ? (
          <div className="card-body">
            <LoadingBlock label="Loading platform usage…" />
          </div>
        ) : items.length === 0 ? (
          <EmptyState
            icon="bi-bar-chart"
            title="No usage aggregates"
            text="Run the aggregation job after usage events exist."
          />
        ) : (
                ...
                {items.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td className="text-end fw-semibold">
                      {formatMetricValue(item.metric, item.quantity)}
                    </td>
                    <td>
