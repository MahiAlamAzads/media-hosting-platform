  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Cross-workspace administrative and product activity."
      />
      <div className="card">
              ...
              <tbody>
                {items.map((x) => (
                  <tr key={x.id}>
                    ...
                    <td>{x.actor?.email ?? x.actorId ?? "System"}</td>
                    <td>{x.workspace?.name ?? "Platform"}</td>
                    <td>
                      {x.entityType}
