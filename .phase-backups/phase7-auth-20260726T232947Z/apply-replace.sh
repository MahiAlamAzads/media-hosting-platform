...
BACKUP_DIR="$TARGET/.phase-backups/phase6-$STAMP"
...
echo
echo "Media Hosting Phase 6 applied."
echo "Backup: $BACKUP_DIR"
echo
echo "Preserved: .env, existing migrations, storage, PostgreSQL data"
echo
echo "Run:"
echo "  cd \"$TARGET\""
echo "  pnpm install"
echo "  pnpm rebuild sharp"
