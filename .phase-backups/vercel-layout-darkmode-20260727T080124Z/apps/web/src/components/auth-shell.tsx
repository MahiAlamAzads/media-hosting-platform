  ...
  return <main className="mp-auth">
    <section className="mp-auth-context">
      ...
      <div>
        ...
        <p>Upload, organize, transform and deliver files from one auditable workspace.</p>
      </div>
      <p className="mp-row-meta">Secure sessions · scoped API keys · signed delivery</p>
    </section>
