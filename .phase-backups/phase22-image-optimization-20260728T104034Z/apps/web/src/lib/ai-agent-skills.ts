...
6. Return assetId, visibility, imgUrl, fileUrl, thumbnailUrl and previewUrl to the application.
7. If any step fails after initialization, DELETE /api/v1/uploads/{uploadId}.
